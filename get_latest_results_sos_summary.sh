...
# echo "Downloading U.S. House results, append to summary file ..." &&
# curl -s $ALLOW_INSECURE --ssl --user media:results ftp://ftp.sos.state.mn.us/20201103/ushouse.txt | sed -e 's/$/;U.S. House/' >> sos/mn_2020_nov_sos__statewide.csv
#
# echo "Downloading U.S. Senate results, append to summary file ..." &&
# curl -s $ALLOW_INSECURE --ssl --user media:results ftp://ftp.sos.state.mn.us/20201103/ussenate.txt | sed -e 's/$/;U.S. Senate/' >> sos/mn_2020_nov_sos__statewide.csv
#
# echo "Downloading MN Senate results, append to summary file ..." &&
# curl -s $ALLOW_INSECURE --ssl --user media:results ftp://ftp.sos.state.mn.us/20201103/stsenate.txt | iconv -f ISO-8859-15 -t UTF-8 | sed -e 's/DuprÈ/Dupré/' | sed -e 's/$/;MN State Senate/' >> sos/mn_2020_nov_sos__statewide.csv
#
...
echo "Downloading municipal results, append to summary file ..." &&
...
csv2json -s ";" sos/mn_2020_nov_sos__statewide.csv | \
  sed 's/@@/\\"/g' | \
  ndjson-cat | \
  ndjson-split > sos/mn_2020_nov_sos__statewide.ndjson
